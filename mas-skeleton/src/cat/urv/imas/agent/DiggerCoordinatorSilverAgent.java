...
import cat.urv.imas.behaviour.diggercoordinatorsilver.*;
 ...
 */
public class DiggerCoordinatorSilverAgent extends ImasAgent {
     ...
     */
    public DiggerCoordinatorSilverAgent() {
        super(AgentType.SILVER_DIGGER_COORDINATOR);
    }
    ...
    protected void setup() {
        ...
        sd1.setType(AgentType.SILVER_DIGGER_COORDINATOR.toString());
