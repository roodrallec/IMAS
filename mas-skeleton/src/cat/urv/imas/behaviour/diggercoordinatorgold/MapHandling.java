 ...
 */
package cat.urv.imas.behaviour.diggercoordinatorgold;
...
import cat.urv.imas.agent.DiggerCoordinatorGoldAgent;
...
public class MapHandling extends AchieveREResponder {
     ...
     */
    public MapHandling(DiggerCoordinatorGoldAgent agent, MessageTemplate mt) {
        super(agent, mt);
    ...
    protected ACLMessage prepareResponse(ACLMessage msg) {
        try {
            DiggerCoordinatorGoldAgent agent = (DiggerCoordinatorGoldAgent)this.getAgent();
